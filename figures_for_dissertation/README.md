# Figures selected for the dissertation

Copied from outputs/ by scripts run on the saved graphs. Every
entry records why the run was chosen and what each page measures,
so a figure cannot reach the document without its evidence.

## ch4-design-aggregation-example

1 node(s) folded, listed in the key

| page | width | prints at | file |
|---|---|---|---|
| 1 | 1124 px | 8.8 pt | `ch4-design-aggregation-example.svg` |
...
the one incident with an expert-drawn reference figure

| page | width | prints at | file |
|---|---|---|---|
| 1 | 896 px | 11.1 pt | `ch6-results-stolen-pencil-generated-p1.svg` |
| 2 | 1194 px | 8.3 pt | `ch6-results-stolen-pencil-generated-p2.svg` |
| 3 | 1054 px | 9.4 pt | `ch6-results-stolen-pencil-generated-p3.svg` |
| 4 | 896 px | 11.1 pt | `ch6-results-stolen-pencil-generated-p4.svg` |
| 5 | 896 px | 11.1 pt | `ch6-results-stolen-pencil-generated-p5.svg` |
| 6 | 898 px | 11.0 pt | `ch6-results-stolen-pencil-generated-p6.svg` |
...
| page | width | prints at | file |
|---|---|---|---|
| 1 | 1282 px | 7.7 pt | `ch6-results-variance-fewer-pages-p1.svg` |
